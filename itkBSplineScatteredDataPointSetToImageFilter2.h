...
=========================================================================*/
#ifndef __itkBSplineScatteredDataPointSetToImageFilter2_h
#define __itkBSplineScatteredDataPointSetToImageFilter2_h
...
class BSplineScatteredDataPointSetToImageFilter2 
: public PointSetToImageFilter<TInputPointSet, TOutputImage>
{
public:
  typedef BSplineScatteredDataPointSetToImageFilter2           Self;
  ...
  typedef BSplineKernelFunction2<3>                            KernelType;  
...
protected:
  BSplineScatteredDataPointSetToImageFilter2();
  virtual ~BSplineScatteredDataPointSetToImageFilter2();
  void PrintSelf( std::ostream& os, Indent indent ) const;

  void GenerateData();

private:
  BSplineScatteredDataPointSetToImageFilter2(const Self&); //purposely not implemented
...
#include "itkBSplineScatteredDataPointSetToImageFilter2.txx"
#endif
