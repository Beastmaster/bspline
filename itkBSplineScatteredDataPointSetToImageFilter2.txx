#ifndef __itkBSplineScatteredDataPointSetToImageFilter2_txx
#define __itkBSplineScatteredDataPointSetToImageFilter2_txx
...
BSplineScatteredDataPointSetToImageFilter2<TInputPointSet, TOutputImage>
...
::SetNumberOfLevels( ArrayType levels )
{
  ...
  this->m_MaximumNumberOfLevels = 10;
  for ( unsigned int i = 0; i < ImageDimension; i++ )
    {
