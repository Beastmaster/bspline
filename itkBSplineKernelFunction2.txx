/*=========================================================================
  ...
  Module:    $RCSfile: itkBSplineKernelFunction2.txx,v $
  Language:  C++
  Date:      $Date: $
  Version:   $Revision: $
...
=========================================================================*/
#ifndef _itkBSplineKernelFunction2_txx
#define _itkBSplineKernelFunction2_txx
...
BSplineKernelFunction2<VSplineOrder>
...
template <unsigned int VSplineOrder>
typename BSplineKernelFunction2<VSplineOrder>::PolynomialType 
BSplineKernelFunction2<VSplineOrder>
...
template <unsigned int VSplineOrder>
typename BSplineKernelFunction2<VSplineOrder>::MatrixType 
BSplineKernelFunction2<VSplineOrder>
